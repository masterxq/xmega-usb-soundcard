...
{
	printf("mic res\n");
	ep_config_isochronous(AUDIO_STREAM_MIC_EPADDR, audio_mem.mic_buffer0, audio_mem.mic_buffer1, AUDIO_STREAM_EPSIZE, &audio_mic_callback0, &audio_mic_callback0);
...
void audio_mic_init()
{
  ...
  DMA.CH3.SRCADDR2 = 0;
	...
	DMA.CH2.TRFCNT                   = AUDIO_STREAM_EPSIZE;
	DMA.CH2.REPCNT                   = 0;
	DMA.CH3.TRFCNT                   = AUDIO_STREAM_EPSIZE;
	DMA.CH3.REPCNT                   = 0;
