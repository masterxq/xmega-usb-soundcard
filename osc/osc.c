...
#ifndef F_CPU //Hack for my IDE to find the DEFINES of the header
...
void int2x_ppl_USB48(uint8_t x2)
{
  ...
  * gesetzt und 32Mhz können benutzt werden*/
  ...
  //System CLK setzen
  OSC.PLLCTRL = OSC_PLLSRC_RC2M_gc | x2; //Select source for PLL and multiply with 16...  2 * 16 = 32 MHz
